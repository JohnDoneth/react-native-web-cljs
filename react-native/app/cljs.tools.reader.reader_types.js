...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41100 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41100(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41102 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41102(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41106 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41106(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41110 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41110(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41112 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41112(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41114 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41114(reader);
}
});
...
var G__41176 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41177 = s.append(c);
c = G__41176;
s = G__41177;
continue;
}
